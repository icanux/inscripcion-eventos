            ...
            <div class="row">
              <div class="col-lg-6">
                ...
                <div class="btn-wrapper">
                  <a href="/eventos" class="btn btn-primary btn-icon mb-3 mb-sm-0">
                    <span class="btn-inner--icon"><i class="ni ni-calendar-grid-58 pr-2"></i></span>
                    <span class="btn-inner--text">Ver Eventos</span>
                  </a>
                  @if(Auth::guest())
                    <a href="/register" class="btn btn-white btn-icon mb-3 mb-sm-0">
                      <span class="btn-inner--icon"><i class="ni ni-single-copy-04"></i></i></span>
